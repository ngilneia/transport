...
if (isset($_POST['approve'])) {
    ...
    if ($updateSQL == TRUE) {
        ...
        $(document).ready(function(){
                ...
                window.location = "routeJDApprovalList.php";
            })});
        </script>';
    } else {
    ...
    $rejectSql = "UPDATE `entry` set jd=2,jdRemarks='$remarks',mvi=NULL,inspection=NULL,inspectionPlace=NULL where entry_id=$id;";
