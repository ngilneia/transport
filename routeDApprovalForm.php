...
if (isset($_POST['approve'])) {
    ...
    $rejectSql = "UPDATE `entry` set d=2,dRemarks='$remarks',mvi=NULL,inspection=NULL,inspectionPlace=NULL where entry_id=$id;";
        ...
        <div class="row">
            ...
            <div class="col-4">
                <table class="table">
                    ...
                    <tr>
                        <td>DEPUTY DIRECTOR REMARKS</td>
                        <td><?php echo $ddRemarks; ?></td>
                    </tr>
                    <tr>
                        <td>JOINT DIRECTOR REMARKS</td>
                        <td><?php echo $jdRemarks; ?></td>
                    </tr>
                </table>
            </div>
            <div class="col-4"></div>
