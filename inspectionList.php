            ...
            ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php echo '<a class="link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" href="http://localhost/transport/' . $row['pVoters'] . '">Voters ID(Transferer)</a><br/>'; ?>
