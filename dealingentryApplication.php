...
if (isset($_POST['submit'])) {
    ...
    `relation`,`news`,`newsDate`,`transferDate`,`appName`,`pNo`,`voters`,`pVoters`,`saleLetter`,`regCertf`,`adtsta`) 
    VALUES ('$name','$fName','$address','$regNo','$reason','$currentOwnerName','$currentOwner','$phoneNo','$VehicleType','$dto','$domain','$dot','$deceased','$place',
    '$relation','$news','$newsDate','$transferDate','$appName','$pNo','$votersFilePath','$pVotersFilePath','$saleLetterFilePath','$regCertfFilePath',1)";
...
<div class="container ">
    ...
    <form class="row g-3" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-4">
            ...
            <input type="text" name="fName" class="form-control border-primary" id="fName" placeholder="S/o / D/o / W/o Name">
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            ...
            <input type="text" name="currentOwnerName" class="form-control border-primary" id="currentOwnerName" placeholder="Present Permit Holder Name">
        </div>
        <div class="col-md-4">
            <label for="currentOwnerAddress" class="form-label">Present Permit Holder Full address</label>
            <input type="text" name="currentOwner" class="form-control border-primary" id="currentOwnerAddress" placeholder="Present Permit Holder Full address">
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            ...
            <select name="VehicleType" class="form-control border-primary" id="VehicleType">
        ...
        <div class="col-md-4">
            ...
            <input type="date" name="dot" class="form-control border-primary" id="dot" placeholder="Date of Transfer" autocomplete="off">
        </div>
        <div class="col-md-4">
        ...
        <div class=" col-md-4">
            ...
            <input type="date" name="deceased" class="form-control border-primary" id="deceased" placeholder="Date of Deceased">
        </div>
        <div class="col-md-4">
            <label for="place" class="form-label">Place of Deceased</label>
            <input type="text" name="place" class="form-control border-primary" id="place" placeholder="Place of Deceased">
        </div>
        <div class="col-md-4">
            <label for="relation" class="form-label">Relation with the deceased person</label>
            <input type="text" name="relation" class="form-control border-primary" id="relation" placeholder="Relation">
        </div>
        <div class="col-md-4">
            <label for="news" class="form-label">Name of News Paper in which notice is published</label>
            <input type="text" name="news" class="form-control border-primary" id="news" placeholder="News Paper">
        </div>
        <div class="col-md-4">
            <label for="newsDate" class="form-label">Date of News Paper in which notice is published</label>
            <input type="date" name="newsDate" class="form-control border-primary" id="newsDate" autocomplete="off">
        </div>
        <div class="col-md-4">
            <label for="transferDate" class="form-label">Effective date of Transfer of Permit</label>
            <input type="date" name="transferDate" class="form-control border-primary" id="transferDate" placeholder="Transfer Date" autocomplete="off">
        </div>
        <div class="col-md-4">
            <label for="appName" class="form-label">Name of Applicant</label>
            <input type="text" name="appName" class="form-control border-primary" id="appName" placeholder="Applicant Name">
        </div>
        <div class="col-md-4">
            <label for="pNo" class="form-label">Phone Number</label>
            <input type="text" name="pNo" class="form-control border-primary" id="pNo" placeholder="Phone No">
        </div>
        <div class="col-md-8">
        ...
        <div class="col-6">
            ...
            <input class="form-control border-primary" name="voters" type="file" id="formFile">
            <label for="formFilev" class="form-label">Voters ID(Transferer)</label>
            <input class="form-control border-primary" name="pVoters" type="file" id="formFilev">
            <label for="formFile1" class="form-label">Sales Letter</label>
            <input class="form-control border-primary" name="saleLetter" type="file" id="formFile1">
            <label for="formFile2" class="form-label">Registration Certificate</label>
            <input class="form-control border-primary" name="regCertf" type="file" id="formFile2">
        </div>
        <div class="col-6">
            <hr />
            ...
            <input class="form-control border-primary" name="policeReport" type="file" id="formFil5e">
            <label for="formFile6" class="form-label">MVI Inspection Report</label>
            <input class="form-control border-primary" name="mvi" type="file" id="formFile6">
            <label for="formFile7" class="form-label">Death Certificate</label>
            <input class="form-control border-primary" name="death" type="file" id="formFile7">
        </div>
        <div class="mb-3">
