 ...
 *   https://datatables.net/download/#bs5/dt-1.13.6/r-2.5.0/sb-1.6.0/sp-2.2.0
 *
 * Included libraries:
 *   DataTables 1.13.6, Responsive 2.5.0, SearchBuilder 1.6.0, SearchPanes 2.2.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.13.6/r-2.5.0/sb-1.6.0/sp-2.2.0",
