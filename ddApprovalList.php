...
<div class="row">
    <div class="col-12">
        <table id=" entry" class="table table-striped" style="width:100%">
            ...
            <tbody>
                <?php
                $sql = "SELECT * FROM entry where adtmv is not null and adtsta is not null and and fromRoute is null dd!=1";
...
<div class="row">
    <a href="dApprovedList.php" class="btn btn-info">Click here to see approved list</a>
</div>
